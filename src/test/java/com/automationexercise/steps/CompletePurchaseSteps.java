...
public class CompletePurchaseSteps {
    ...
    public void iEntersPaymentDetailsNameOnCardCardNumberCvcExpireMonthExpireYear(String name, String number, String cvv, String month, String year) {
        new PaymentPage().enterPaymentDetailsOnField(name, number, cvv, month, year);
    }
