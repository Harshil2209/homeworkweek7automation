...
Feature: Complete Purchase Flow with Existing Account
  ...
  Scenario: Complete the purchase flow with existing account
    ...
    And I enters the correct emailAddress "virat123@gmail.com" and password "123456"
    And I clicks the Login button
    Then I verifies that Logged in as username "virat" is visible
    ...
    And I enters payment details nameOnCard "virat Patel", cardNumber "5555 5555 5555 4444", cvc "598", expireMonth "12", expireYear "2030"
