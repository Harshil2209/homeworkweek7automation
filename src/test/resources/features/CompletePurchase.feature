...
Feature: Complete Purchase Flow
  ...
  Scenario: Complete the purchase flow
    ...
    And I fills My personal details firstname "Manish", lastname "Patel", company "zoom", address "5, kenton", addressTwo "Harrow Road", country "england", state "UK", city "London", zipcode "234110", mobileNumber "07587402063"
    ...
    And I enters payment details nameOnCard "Neel Patel", cardNumber "5555 5555 5555 4444", cvc "598", expireMonth "12", expireYear "2030"
