...
Feature: Complete Purchase Flow with Account Creation
  ...
  Scenario: Complete the purchase flow with account creation
    ...
    And I enters the name "smith"
    And I enters email "smith123@gmail.com"
    ...
    And I fills My personal details firstname "smith", lastname "cook", company "zoom", address "5, kenton", addressTwo "Harrow Road", country "england", state "UK", city "London", zipcode "234102", mobileNumber "07587402063"
    And I clicks the Create Account button
    And I verifies that ACCOUNT CREATED! is visible
    And I clicks the Continue button
    And I verifies that Logged in as username "smith" is visible
    ...
    And I enters payment details nameOnCard "tom cook", cardNumber "5555 5555 5555 4444", cvc "532", expireMonth "12", expireYear "2030"
